...
function Navbar() {
  ...
  return (
    <header className="fixed w-full border-t-4 bg-white dark:bg-gray-800 border-indigo-600 dark:border-indigo-900 shadow dark:shadow-2 z-50">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center -mx-2">
            ...
            <a
              ...
              href="https://twitter.com/ashansube"
